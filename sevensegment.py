...
This is a fun little module that emulates a seven segment display (The one found
on digital calulators and watches). The display is stored as a pygame surface
